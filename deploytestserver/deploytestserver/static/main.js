...
module.exports = __webpack_require__(/*! C:\Users\amey sonje\deploy_angular_django_test\deploytest\src\main.ts */"zUnb");
...
class AppComponent {
    constructor(api, fb) {
        ...
        this.fb = fb;
        this.datatosent = '';
        this.title = 'deploytest';
        this.TestDataform = this.fb.group({
            data1: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]]
        });
    }
    ...
    onSubmit(TestDataform1) {
        ...
        this.api.sendData(this.datatosent).subscribe(data => {
            console.log(data);
        }, error => {
            console.log(error);
        });
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]])], decls: 6, vars: 1, consts: [[3, "formGroup", "ngSubmit"], [1, "form-group"], ["type", "text", "placeholder", "Type text", 1, "form-control"], ["type", "submit", 1, "btn", "btn-block", "btn-success"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AppComponent_Template_form_ngSubmit_0_listener() { return ctx.onSubmit(ctx.TestDataform); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("formGroup", ctx.TestDataform);
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAuY29tcG9uZW50LmNzcyJ9 */"] });
...
class ApiService {
    ...
    sendData(data1) {
        ...
        console.log(data1);
        return this.http.post(this.baseurl + '/outputplot/', body, { headers: this.httpHeaders });
    }
    senddata_topython() {
